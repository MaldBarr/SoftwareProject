...
class RecordatorioScreen extends StatelessWidget {
  ...
  /// Navigates to the agregarRecordatorioScreen when the action is triggered.
  AgregarRecordatorio(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.agregarRecordatorioScreen);
  }
}
